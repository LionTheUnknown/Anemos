      ...
      >
        {RAIN_TYPES.map(({ type, label }) => (
          <button
            ...
            style={{
              border: rainType === type ? "0.0625rem solid rgba(255,255,255,0.2)" : "0.0625rem solid transparent",
              boxShadow: rainType === type ? "0 0.125rem 0.5rem 0 rgba(96,165,250,0.12)" : undefined,
              minWidth: "4.5rem",
            }}
          >
            {label}
