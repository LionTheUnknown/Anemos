        ...
        try {
            requestedWeather = webWeatherClient.get()
                    .uri(uriBuilder -> uriBuilder
                            ...
                            .queryParam("daily", "sunset,sunrise,temperature_2m_max,temperature_2m_min,weather_code")
                            .queryParam("current", "wind_speed_10m,relative_humidity_2m,precipitation,temperature_2m,apparent_temperature,weather_code")
                            .build())
                    .retrieve()
